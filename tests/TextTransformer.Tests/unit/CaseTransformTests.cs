public class CaseTransformTests
{
    ...
    {
        var transform = new CaseTransform(CaseOption.None);
    ...
    {
        var transform = new CaseTransform(CaseOption.Lower);
        var result = transform.Transform("MiXeD Case w/ PunctuatioN!");
        Assert.Equal("mixed case w/ punctuation!", result);
    }
    ...
    {
        var transform = new CaseTransform(CaseOption.Upper);
        var result = transform.Transform("MiXeD Case w/ PunctuatioN!");
        Assert.Equal("MIXED CASE W/ PUNCTUATION!", result);
    }
    ...
    {
        var transform = new CaseTransform(CaseOption.Title);
        var result = transform.Transform("MiXeD Case w/ PunctuatioN!");
        Assert.Equal("Mixed Case W/ Punctuation!", result);
    }
}
